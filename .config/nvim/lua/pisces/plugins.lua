...
vim.keymap.set('n', ';wo', require('telescope.builtin').oldfiles, { desc = '[?] Find recently opened files' })
...
vim.keymap.set('n', ';r', require('telescope.builtin').resume, { desc = '[S]earch [R]esume' })
